...
import { Home, FolderKanban, UserPlus, LayoutGrid, User, Moon, Sun, ChevronLeft, ChevronRight, Settings, Receipt } from 'lucide-react';
          ...
          >
            ...
            {!collapsed && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs opacity-70 truncate">Administrator</p>
              </div>
            )}
          </Link>
        </div>

...
import { Bell, Globe, Lock, Mail, Smartphone, Check, UserCircle } from 'lucide-react';
...
export function Settings() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      {/* Profile Notice */}
      <div className="p-4 bg-gray-50 dark:bg-gray-900/50 rounded-2xl border border-gray-200 dark:border-gray-700 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <UserCircle className="w-5 h-5 text-gray-400" />
            <p className="text-gray-900 dark:text-gray-50 text-sm">
              To change your name or email, use your Profile.
            </p>
          </div>
          <button
            onClick={() => navigate('/profile')}
            className="px-4 py-2 text-gray-800 dark:text-gray-100 hover:bg-blue-100 dark:hover:bg-blue-900/40 rounded-lg transition-colors border border-blue-300 dark:border-blue-700 text-sm"
          >
            Open Profile
          </button>
        </div>

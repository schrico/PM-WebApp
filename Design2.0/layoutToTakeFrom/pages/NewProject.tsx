...
export function NewProject() {
  ...
  const [formData, setFormData] = useState({
    ...
    system: sourceProject?.system || 'Phrase',
    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          {duplicateFromId ? 'Create a new project based on existing project details' : 'Create a new translation project'}
        </p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData({ ...formData, lines: parseInt(e.target.value) || 0 })}
                className="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="0"
              />
            </div>

...
const projects: Project[] = [
  { id: '1', system: 'Phrase', project: 'Marketing Campaign Q4', words: 2500, lines: 180, translators: [], dueDate: '2025-11-25', instructions: 'Follow brand guidelines' },
  { id: '2', system: 'Trados', project: 'Legal Contract Translation', words: 4200, lines: 310, translators: ['John Smith'], dueDate: '2025-11-22', instructions: 'Certified translation required' },
  { id: '3', system: 'MemoQ', project: 'Technical Manual v2.3', words: 8900, lines: 650, translators: ['Maria Garcia', 'Jean Dupont'], dueDate: '2025-11-28', instructions: 'Use glossary provided' },
  { id: '4', system: 'Phrase', project: 'Website Localization', words: 1800, lines: 125, translators: [], dueDate: '2025-11-24', instructions: 'SEO keywords must be maintained' },
  { id: '5', system: 'Trados', project: 'User Guide Translation', words: 3200, lines: 240, translators: ['Anna Kowalski'], dueDate: '2025-11-20', instructions: 'Maintain formatting' },
];
